...
MANAGED_FILES=(
  ...
  ".ai/workflows/sdd-linear/contracts/runtime-outcome.schema.json"
  ".ai/workflows/sdd-linear/contracts/runtime-preflight.schema.json"
  ...
  ".ai/workflows/sdd-linear/runtime/__init__.py"
  ".ai/workflows/sdd-linear/runtime/ports.py"
  ".ai/workflows/sdd-linear/runtime/preflight.py"
  ".ai/workflows/sdd-linear/runtime/adapters/__init__.py"
